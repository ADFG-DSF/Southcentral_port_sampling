...
#########
Appendix A1.- Species composition of rockfish harvests from Cook Inlet ports, 1996-2019.
```{r}
tab_spp <- 
  est_spp %>%
...
filter(tab_spp, port == "Cook Inlet") %>%
  flextable() %>%
  merge_v(j = ~ port) %>%
...
#########
Appendix A2.- Species composition of rockfish harvests from Kodiak Harbor, 1996-2019.
```{r}
filter(tab_spp, port == "Kodiak") %>%
  flextable() %>%
    merge_v(j = ~ port) %>%
    valign(j = 1, valign = "top") %>%
    align(j = c(3:8), align = "right") %>%
...
#########
Appendix A3.- Species composition of rockfish harvests from the Seward Harbor, 1996-2019.
```{r}
filter(tab_spp, port == "Seward") %>%
  flextable() %>%
    merge_v(j = ~ port) %>%
    valign(j = 1, valign = "top") %>%
    align(j = c(3:8), align = "right") %>%
...
#########
Appendix A4.- Species composition of rockfish harvests from Valdez Harbor, 1996-2019.
```{r}
filter(tab_spp, port == "Valdez") %>%
  flextable() %>%
    merge_v(j = ~ port) %>%
    valign(j = 1, valign = "top") %>%
    align(j = c(3:8), align = "right") %>%
...
#########
Appendix A5.- Species composition of rockfish harvests from Whittier Harbor, 1999-2019.
```{r}
filter(tab_spp, port == "Whittier") %>%
  flextable() %>%
    merge_v(j = ~ port) %>%
    valign(j = 1, valign = "top") %>%
    align(j = c(3:8), align = "right") %>%
...
#########
Appendix E2.- Length composition of Yelloweye rockfish in the harvest from five Gulf of Alaska ports. 
```{r, results = "asis"}
lgbin_format <- 
  est_lgbin %>%
  rowwise() %>%
...
#########
Appendix G2.- Percentage of female of yelloweye rockfish in the harvest from five Gulf of Alaska ports.
```{r}
est_sex %>%
