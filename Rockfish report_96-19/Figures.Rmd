...
ggplot() +
  geom_point(data = list_lgage[[2]][list_lgage[[2]]$var == "Linf", ],
             aes(x = port, y = val, color = sex), 
             position = position_dodge(width = 0.5), 
             size = 3) +
  geom_errorbar(data=list_lgage[[3]][list_lgage[[3]]$var == "Linf", ],
...
ggplot() +
  geom_point(data = list_lgage[[5]][list_lgage[[5]]$var == "K",],
             aes(x = port, y = val, color = sex), 
             position = position_dodge(width = 0.5), 
             size = 3) +
  geom_errorbar(data=list_lgage[[6]][list_lgage[[6]]$var == "K",],
                aes(x = port, color = sex, ymin = LCI, ymax = UCI), 
                size = 1, 
                width = 0.3, 
                position = position_dodge(width = 0.5)) +
...
knitr::include_graphics(".//fig_weight.png")
```

```{r, fig.height = 6, fig.width = 7.5, fig.cap = "Empirical spatial composition (areas) and estimated mean spatial composition (lines) of sport fishing effort in Cook Inlet, 2000-2019."}
knitr::include_graphics(".//plot_HomerE.png")
```

```{r, fig.height = 6, fig.width = 7.5, fig.cap = "Empirical spatial composition (areas) and estimated mean spatial composition (lines) of the pelagic rockfish harvest in Cook Inlet, 1996-2019."}
knitr::include_graphics(".//plot_HomerHp.png")
```
  
```{r, fig.height = 6, fig.width = 7.5, fig.cap = "Empirical spatial composition (areas) and estimated mean spatial composition (lines) of the non-pelagic rockfish harvest in Cook Inlet, 1996-2019."}
knitr::include_graphics(".//plot_HomerHnp.png")
```
...
knitr::include_graphics(".//plot_KodiakE.png")
```  
...
knitr::include_graphics(".//plot_KodiakHp.png")
```
...
knitr::include_graphics(".//plot_KodiakHnp.png")
```
...
knitr::include_graphics(".//plot_SewardE.png")
```
...
knitr::include_graphics(".//plot_SewardHp.png")
```
...
knitr::include_graphics(".//plot_SewardHnp.png")
```
...
knitr::include_graphics(".//plot_ValdezE.png")
```
...
knitr::include_graphics(".//plot_ValdezHp.png")
```
...
knitr::include_graphics(".//plot_ValdezHnp.png")
```
...
knitr::include_graphics(".//plot_WhittierE.png")
```
...
knitr::include_graphics(".//plot_WhittierHp.png")
```
...
knitr::include_graphics(".//plot_WhittierHnp.png")
```
