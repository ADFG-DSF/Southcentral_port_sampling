#Calls in different harvest data but otherwise mostly similar to mutinomial effort.R
library(magrittr)
library(ggplot2)
...
#Group stat areas into geographic areas (expanded becaseu of catchs from areas w no effort)
sort(unique(dat0c$stat_area))
plot_names <- c("Outer Gulf Coast", #"505903"
                "Pacific Ocean",    #"515831"
                "Pacific Ocean",    #"515832" Barren Islands
                "Outer Gulf Coast", #"515901"
                "Pacific Ocean",    #"515902"
                "Outer Gulf Coast", #"515903"
                "Pacific Ocean",    #"515904"
                "Outer Gulf Coast", #"515905"
                "Outer Gulf Coast", #"515906"
                "Kachemak Bay",     #"515907"
                "Kachemak Bay",     #"515908"
                "Kachemak Bay",     #"515931"
                "Kachemak Bay",     #"515932"
                ...
                "Cook Inlet",       #"515938"
                "Cook Inlet",       #"515939"
                "Pacific Ocean",    #"515802"
                "Pacific Ocean",    #"515832"
                "Pacific Ocean",    #"515834"
                "Pacific Ocean",    #"515835"
                "Pacific Ocean",    #"515836"
                "Pacific Ocean",    #"515837"
                "Outer Gulf Coast", #"525901"
                "Cook Inlet",       #"525902"
                "Cook Inlet",       #"525931"
                "Cook Inlet",       #"525932"
                "Cook Inlet",       #"526000"
                ...
                "Cook Inlet",       #"535932"
                "Cook Inlet")       #"535933"
names(plot_names) <- sort(unique(dat0c$stat_area))
...
#samples sizes indaequate for Private Fleet
dat %>% 
